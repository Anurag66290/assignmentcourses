...
function TestReport() {
  ...
  const columns = ["S.No.", "Activity ", "performance",  ];
  let finalArray = [];
  ...
  for (let [index, data] of usersData?.entries()) {
    ...
    dataArray.push(data.Activity);
    dataArray.push(data.performance);
